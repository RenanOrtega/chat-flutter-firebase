import 'package:chat_flutter_firebase/common/routes/pages.dart';
import 'package:flutter/material.dart';

class RouteObservers<R extends Route<dynamic>> extends RouteObserver<R> {
  @override
  void didPush(Route<dynamic> route, Route<dynamic>? proviousRoute) {
    super.didPush(route, proviousRoute);
